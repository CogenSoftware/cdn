...
function TedarikciUrunleri(cboTedarikci, deger, islem) {
    if (islem == true) {
        ...
        var txtUrunBirimFiyati = $(cboTedarikci).parent().parent().parent().find(".txtUrunBirimFiyati");
                                ...
                                if (data.length > 0) {
                                    ...
                                    if (cHTML != '') {
                                        cHTML =
                                            ...
                                            "<a class=\"btn btn-secondary btn-block btn-delete-3\" data-toggle=\"collapse\" href=\"#digerOzellikler-" + iUrunId + "\" role=\"button\" aria-expanded=\"false\" aria-controls=\"digerOzellikler-" + iUrunId + "\" tabindex=\"6\">Diğer Özellikler</a>" +
                                            "</div>" +
                                            ...
                                            "<input autocomplete=\"off\" class=\"form-control txtMasaTabla\" id=\"cMasaTabla-" + iUrunId + "\" maxlength=\"100\" name=\"cMasaTabla\" onchange=\"ProductWrite()\" placeholder=\"Lütfen tabla rengi girin ...\" tabindex=\"11\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cMasaOnPerde\">(Ahşap Renkleri - Masa) Ön Perde</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtMasaOnPerde\" id=\"cMasaOnPerde-" + iUrunId + "\" maxlength=\"100\" name=\"cMasaOnPerde\" onchange=\"ProductWrite()\" placeholder=\"Lütfen ön perde rengi girin ...\" tabindex=\"12\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3\">" +
                                            "<label for=\"cEtajerGovde\">(Ahşap Renkleri - Etajer) Gövde</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtEtajerGovde\" id=\"cEtajerGovde-0" + iUrunId + "\" maxlength=\"100\" name=\"cEtajerGovde\" onchange=\"ProductWrite()\" placeholder=\"Lütfen gövde rengi girin ...\" tabindex=\"13\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "</div>" +
                                            "<div class=\"row\">" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cEtajerTac\">(Ahşap Renkleri - Etajer) Taç</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtEtajerTac\" id=\"cEtajerTac-" + iUrunId + "\" maxlength=\"100\" name=\"cEtajerTac\" onchange=\"ProductWrite()\" placeholder=\"Lütfen taç rengi girin ...\" tabindex=\"14\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cEtajerKapak\">(Ahşap Renkleri - Etajer) Kapak</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtEtajerKapak\" id=\"cEtajerKapak-" + iUrunId + "\" maxlength=\"100\" name=\"cEtajerKapak\" onchange=\"ProductWrite()\" placeholder=\"Lütfen kapak rengi girin ...\" tabindex=\"15\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cEtajerKlapa\">(Ahşap Renkleri - Etajer) Klapa</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtEtajerKlapa\" id=\"cEtajerKlapa-" + iUrunId + "\" maxlength=\"100\" name=\"cEtajerKlapa\" onchange=\"ProductWrite()\" placeholder=\"Lütfen klapa rengi girin ...\" tabindex=\"16\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3\">" +
                                            "<label for=\"cKesonGovde\">(Ahşap Renkleri - Keson) Gövde</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtKesonGovde\" id=\"cKesonGovde-" + iUrunId + "\" maxlength=\"100\" name=\"cKesonGovde\" onchange=\"ProductWrite()\" placeholder=\"Lütfen gövde rengi girin ...\" tabindex=\"17\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "</div>" +
                                            "<div class=\"row\">" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cKesonTac\">(Ahşap Renkleri - Keson) Taç</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtKesonTac\" id=\"cKesonTac-" + iUrunId + "\" maxlength=\"100\" name=\"cKesonTac\" onchange=\"ProductWrite()\" placeholder=\"Lütfen taç rengi girin ...\" tabindex=\"18\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cKesonKlapa\">(Ahşap Renkleri - Keson) Klapa</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtKesonKlapa\" id=\"cKesonKlapa-" + iUrunId + "\" maxlength=\"100\" name=\"cKesonKlapa\" onchange=\"ProductWrite()\" placeholder=\"Lütfen klapa rengi girin ...\" tabindex=\"19\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cBasicGrubuAyak\">(Metal Renkleri - Basic Grubu) Ayak</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtBasicGrubuAyak\" id=\"cBasicGrubuAyak-" + iUrunId + "\" maxlength=\"100\" name=\"cBasicGrubuAyak\" onchange=\"ProductWrite()\" placeholder=\"Lütfen ayak rengi girin ...\" tabindex=\"20\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3\">" +
                                            "<label for=\"cBasicGrubuTraversAtki\">(Metal Renkleri - Basic Grubu) Travers/Atkı</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtBasicGrubuTraversAtki\" id=\"cBasicGrubuTraversAtki-" + iUrunId + "\" maxlength=\"100\" name=\"cBasicGrubuTraversAtki\" onchange=\"ProductWrite()\" placeholder=\"Lütfen travers/atkı rengi girin ...\" tabindex=\"21\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "</div>" +
                                            "<div class=\"row\">" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cBasicGrubuKose\">(Metal Renkleri - Basic Grubu) Köşe</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtBasicGrubuKose\" id=\"cBasicGrubuKose-" + iUrunId + "\" maxlength=\"100\" name=\"cBasicGrubuKose\" onchange=\"ProductWrite()\" placeholder=\"Lütfen köşe rengi girin ...\" tabindex=\"22\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cDolapRenkleriGovde\">(Dolap Renkleri) Gövde</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtDolapRenkleriGovde\" id=\"cDolapRenkleriGovde-" + iUrunId + "\" maxlength=\"100\" name=\"cDolapRenkleriGovde\" onchange=\"ProductWrite()\" placeholder=\"Lütfen gövde rengi girin ...\" tabindex=\"23\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            "<label for=\"cDolapRenkleriTac\">(Dolap Renkleri) Taç</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtDolapRenkleriTac\" id=\"cDolapRenkleriTac-" + iUrunId + "\" maxlength=\"100\" name=\"cDolapRenkleriTac\" onchange=\"ProductWrite()\" placeholder=\"Lütfen taç rengi girin ...\" tabindex=\"24\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "<div class=\"form-group col-md-3\">" +
                                            "<label for=\"cDolapRenkleriKapak\">(Dolap Renkleri) Kapak</label>" +
                                            "<input autocomplete=\"off\" class=\"form-control txtDolapRenkleriKapak\" id=\"cDolapRenkleriKapak-" + iUrunId + "\" maxlength=\"100\" name=\"cDolapRenkleriKapak\" onchange=\"ProductWrite()\" placeholder=\"Lütfen kapak rengi girin ...\" tabindex=\"25\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "</div>" +
                                            "<div class=\"row\">" +
                                            "<div class=\"form-group col-md-3 pr-0\">" +
                                            ...
                                            "<input autocomplete=\"off\" class=\"form-control txtAciklama\" id=\"cAciklama-" + iUrunId + "\" name=\"cAciklama\" onchange=\"ProductWrite()\" placeholder=\"Lütfen özel talep girin ...\" tabindex=\"29\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "</div>" +
                                            "</div>" +
                                            "</div>";
                ...
                if (data != null) {
                    ...
                    if (lVarMi == false) {
                        ...
                        $('#urun4Listesi').find('.row').each(function () {
                            ...
                            $('#cUrun4Listesi').val($('#cUrun4Listesi').val() + $(this).find('.txtUrunKodu').val() + "*" + $(this).find('.cboUrunAdi').val() + "*" + $(this).find('.txtUrunAdet').val() + "*" + $(this).find('.txtUrunBirimFiyati').val() + "*" + $(this).find('.txtUrunFiyat').val())
                        });
                    }
...
function Product(cboUrunAdi) {
    ...
    $.ajax({
        type: "GET",
        url: "/api/urun4api/1/" + $(cboUrunAdi).val() + "/?" + new Date(),
        contentType: "json",
        dataType: "json",
        success: function (data) {
            if (data != null) {
