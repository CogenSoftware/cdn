...
$(function () {
    ...
    $("#btnSayfaSonuEkle").click(function () {
        SayfaSonuEkle();
    });
});
...
function AraToplamEkle() {
    ...
    if (lSecimYap == false) {
        ...
        var cHTML =
            ...
            "</div>" +
            "<div class=\"col-md-2\">" +
            "<button onclick=\"ProductDelete(this)\" type=\"button\" class=\"btn btn-secondary btn-block btn-delete-3\" tabindex=\"7\" style=\"margin-top:0px;\">Sil</button>" +
            "</div>" +
            "</div>" +
            "</div>";
...
function SayfaSonuEkle() {
    ...
    if (lSecimYap == false) {
        ...
        var cHTML =
            "<div data-id=\"sayfaSonuSatiri\" class=\"urunSatiri\">" +
            "<div class=\"row\">" +
            "<div class=\"col-md-10\">" +
            "<p class=\"sayfa-sonu-satiri\">*** Sayfa Sonu ***</p>" +
            "</div>" +
            "<div class=\"col-md-2\">" +
            "<button onclick=\"ProductDelete(this)\" type=\"button\" class=\"btn btn-secondary btn-block btn-delete-3\" tabindex=\"7\" style=\"margin-top:0px;\">Sil</button>" +
            "</div>" +
    ...
    $('#urun4Listesi').find('.urunSatiri').each(function () {
        if ($(this).attr("data-id") == "urunSatiri") {
            ...
            $('#cUrun4Listesi').val(
                ...
                "-1" + "*" +
                "-1");
        } else if ($(this).attr("data-id") == "sayfaSonuSatiri") {
            if ($('#cUrun4Listesi').val() != '') {
                $('#cUrun4Listesi').val($('#cUrun4Listesi').val() + "|");
            }
