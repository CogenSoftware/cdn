...
function ProductAdd() {
    ...
    for (var i = 0; i < iUrunId + 1; i++) {
        if ($("#iKodDepo-" + i).val() == 0 || $("#iAdet-" + i).val() == 0 || $("#cBirimFiyati-" + i).val() == '' || $("#cFiyat-" + i).val() == '' || $("#cBirimFiyati-" + i).val() == "0.00" || $("#cFiyat-" + i).val() == "0.00") {
            lSecimYap = false;
        }
    }
                                ...
                                if (data.length > 0) {
                                    ...
                                    if (cHTML != '') {
                                        cHTML =
                                            ...
                                            "</div>" +
                                            "<div class=\"form-group col-md-2\">" +
                                            "<label for=\"cDuzenlenmeTarihi\">Duzenlenme Tarihi</label>" +
                                            ...
                                            "<input autocomplete=\"off\" class=\"form-control txtAciklama\" id=\"cAciklama-" + iUrunId + "\" name=\"cAciklama\" onchange=\"ProductWrite()\" placeholder=\"Lütfen özel talep girin ...\" tabindex=\"31\" type=\"text\" value=\"\">" +
                                            "</div>" +
                                            "</div>" +
                                            "</div>" +
                                            "</div>";
